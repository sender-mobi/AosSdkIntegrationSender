...
public class GifImageView extends ImageView implements Runnable {
    ...
    public void setUrlImage(String url, final EndLoadImageListener elil) {
        if (animationThread != null) {
            if (elil != null) elil.end();
            return;
        }
        Tool.log("gifurl=" + url);
        new GifDataDownloader(getContext()) {
            @Override
    ...
    public interface EndLoadImageListener {
        void end();
    }
